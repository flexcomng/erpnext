...
default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://flexcomsystems.net">Flexcom ERP</a></div>"""
	...
	erpnext_navbar_items = [
		{
			...
			'item_type': 'Route',
			'route': 'https://flexcomsystems.net',
			'is_standard': 1
		},
		{
			'item_label': 'User Forum',
			'item_type': 'Route',
			'route': 'https://flexcomsystems.net/forums',
			'is_standard': 1
		},
		{
			'item_label': 'Report an Issue',
			'item_type': 'Route',
			'route': 'https://flexcomsystems.net/issues',
			'is_standard': 1
		}
	]
